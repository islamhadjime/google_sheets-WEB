...
let rs_arry = [
    ...
    // {"id":"id_3","city":"с.Сержень-юрт"},
    // {"id":"id_4","city":"с.Агишты"},
    // {"id":"id_5","city":"с.Автуры"},
    // {"id":"id_6","city":"с.Белгатой"},
    // {"id":"id_7","city":"п.Чири-юрт"},
    // {"id":"id_8","city":"с.Мескер-юрт"},
    // {"id":"id_9","city":"с.Дуба-юрт"},
    // {"id":"id_10","city":"Атаги"}
]
